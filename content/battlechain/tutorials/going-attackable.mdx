...
<Note>
**Testnet:** approval is instant — the `MockRegistryModerator` is a permissionless contract you call yourself instead of waiting for a real DAO action. See [How to Request Attack Mode](/battlechain/how-to/request-attack-mode#testnet-instant-approval) for the exact command.
</Note>
</Network>
