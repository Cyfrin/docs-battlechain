...
See [How Deployment Works](/battlechain/explanation/how-deployment-works#foundry-on-battlechain) for the full list of BattleChain Foundry flags and how the deploy stack fits together.
</Warning>
...
```bash
cast nonce --rpc-url %%testnet.rpc%% <your-wallet-address>
```
