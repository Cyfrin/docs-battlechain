...
{/* COMING SOON — AI Desktop prerequisites
**[Claude Desktop](https://claude.ai/download)** (macOS or Linux). If you completed the quickstart with Claude Desktop, continue in the same conversation. If starting fresh, select **Code** at the top and choose the `battlechain-starter` folder.
...
{/* COMING SOON — AI Desktop verify attackable
```
...
{/* COMING SOON — AI Desktop execute attack
```
Run `just attack` to execute the reentrancy exploit against the vault.
Use --skip-simulation for all forge script calls.
```

Enter your keystore password when prompted. Watch the output — Claude will show you the vault draining in real time.
*/}
...
Enter your keystore password when prompted. Watch the output:
