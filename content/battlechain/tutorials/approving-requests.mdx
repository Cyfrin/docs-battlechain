...
<Tip>
The **[Approvals dashboard](https://approvals.battlechain.com)** packages the monitoring, review, and decision steps below into one UI: it indexes every request, surfaces protocol details and bounty terms, and — once you connect the moderator Safe — approves or rejects with a click. This tutorial covers the underlying flow so you understand what the dashboard does on your behalf.
</Tip>
