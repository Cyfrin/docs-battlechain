...
New to the BattleChain deploy stack? [How Deployment Works](/battlechain/explanation/how-deployment-works) explains how `just`, `battlechain-lib`, `BattleChainDeployer`, and CreateX fit together.
...
Point them at the [mock dependency contracts](/battlechain/reference/mock-contracts) — they share the same interfaces as the real ones, so you can deploy your exact production bytecode and only swap the addresses.
</Network>
