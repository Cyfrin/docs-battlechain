...
Ensure the RPC URL is entered exactly as `https://testnet.battlechain.com`.

### Wrong chain ID

Remove the BattleChain network from your wallet and re-add it with Chain ID `627`. See [Add BattleChain to MetaMask](/battlechain/how-to/add-battlechain-to-metamask).
