...
For how the deploy stack fits together and the full flag list, see [How Deployment Works](/battlechain/explanation/how-deployment-works).
...
Ensure the RPC URL is entered exactly as `%%testnet.rpc%%` (testnet) or `%%mainnet.rpc%%` (mainnet).
