...
The examples below use the testnet endpoints. For mainnet, swap in chain ID `626`, the mainnet verifier API, and `%%mainnet.rpc%%` as the RPC URL.
...
| `--rpc-url` | `%%testnet.rpc%%` | BattleChain testnet RPC |
