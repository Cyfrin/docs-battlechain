...
The examples below use the testnet endpoints. For mainnet, swap in chain ID `626`, the mainnet verifier API, and `https://mainnet.battlechain.com` as the RPC URL.
...
| `--rpc-url` | `https://testnet.battlechain.com` | BattleChain testnet RPC |
