...
chains[0] = Chain({
    caip2ChainId: "%%active.caip2%%",  // BattleChain (eip155:627 testnet, eip155:626 mainnet)
...
agreement.addAccounts("%%active.caip2%%", newAccounts);
...
<Card title="How to Request Attack Mode" icon="arrow-right" href="/battlechain/how-to/request-attack-mode">
