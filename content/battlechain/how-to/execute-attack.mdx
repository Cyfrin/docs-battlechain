...
string memory recoveryStr = agreement.getAssetRecoveryAddress("%%active.caip2%%");
...
How the bounty is calculated — the formula, the USD cap, and retainable vs return-all settlement — is defined in **[Bounty Terms → Calculation and Settlement](/battlechain/reference/bounty-terms#bounty-calculation-and-settlement)**.
...
<Card title="How to Claim Bounties" icon="arrow-right" href="/battlechain/how-to/claim-bounties">
