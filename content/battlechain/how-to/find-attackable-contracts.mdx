...
You can browse agreement statuses and contracts under scope on the [BattleChain explorer](https://explorer.testnet.battlechain.com/agreements), or enumerate them programmatically with the API below.
...
```bash
forge script script/CheckTarget.s.sol --ffi --rpc-url %%testnet.rpc%%
```
