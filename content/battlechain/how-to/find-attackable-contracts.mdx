...
curl "%%active.explorerApi%%/battlechain/agreements?state=UNDER_ATTACK"
```
...
curl "%%active.explorerApi%%/battlechain/agreement/<AGREEMENT_ADDRESS>"

# Which agreement (if any) covers a given contract
curl "%%active.explorerApi%%/battlechain/agreement/by-contract/<CONTRACT_ADDRESS>"

# A contract's current security state
curl "%%active.explorerApi%%/battlechain/contract-state/<CONTRACT_ADDRESS>"
```
