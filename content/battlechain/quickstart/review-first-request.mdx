...
<div className="flex items-start gap-4 mb-10 p-5 rounded-xl border border-violet-500/40 bg-violet-950/20">
  ...
  <div>
    <div className="text-xs font-bold uppercase tracking-widest text-violet-400 mb-1">You are the DAO</div>
    <div className="text-base font-semibold text-gray-100 mb-1">A protocol wants to open their contracts for attack. You decide if they're allowed to.</div>
    <div className="text-sm text-gray-400">Your job is to prevent abuse — mainly ensuring no one copies a live mainnet protocol onto BattleChain to have it "attacked" and drained under Safe Harbor cover.</div>
  </div>
</div>
