...
<CardGroup cols={2}>
  <Card title="Going Attackable" icon="shield" href="/battlechain/tutorials/going-attackable">
    Understand the full attack mode process
  </Card>
  <Card title="Add BattleChain to MetaMask" icon="wallet" href="/battlechain/how-to/add-battlechain-to-metamask">
    Manual network setup if MetaMask doesn't auto-add
  </Card>
</CardGroup>
