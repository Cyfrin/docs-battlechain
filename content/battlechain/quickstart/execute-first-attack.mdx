...
<div className="flex items-start gap-4 mb-10 p-5 rounded-xl border border-red-200 bg-red-50 dark:border-red-600/40 dark:bg-red-950/20">
  ...
  <div>
    ...
    <div className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-1">The vault is live. The DAO approved it. You know exactly what's wrong with it.</div>
    <div className="text-sm text-gray-600 dark:text-gray-400">You spotted a CEI violation and you have a contract that exploits it. The Safe Harbor agreement is in place — what you're about to do is legal, structured, and profitable.</div>
  </div>
</div>
