...
Check that you have enough ETH on BattleChain Testnet and that your keystore is set up correctly. If a transaction reverts, ask your AI to check the revert reason and retry.

### I have a stuck pending transaction

Tell your AI: *"I have a stuck transaction at nonce [N]. Send a replacement with a higher gas price using cast send with --value 0 to clear it."* You can find your pending nonce by looking at your wallet or searching your address on the [explorer](https://explorer.testnet.battlechain.com/).
